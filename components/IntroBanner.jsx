...
const IntroBanner = () => {
  ...
  return (
    <>
      <section
        className={`${
          router === "/" ? "bg-[#012555]" : "responsive-banner"
        }  mb-20 max-md:mb-10`}
      >
        <div className="max-w-screen-2xl max-2xl:px-24 max-md:px-14 max-sm:px-5 px-10  mx-auto flex lg:flex-row flex-col items-center ">
          {router === "/" ? (
            <>
              <div className="lg:flex-grow lg:w-1/2 lg:pr-24 md:pr-16 flex flex-col lg:items-start lg:text-left mb-16 md:mb-0 items-center text-center max-md:mb-0 py-10">
                ...
                <div className="flex justify-center">
                  <Link
                    href="/pricing"
                    className="bg-white hover:bg-[#ffffffad] transition-all text-[#012555] p-2 px-6 text-2xl font-medium rounded-lg max-xl:text-lg max-sm:text-sm max-sm:font-medium"
                  >
                    Join Today
                  </Link>
                </div>
            ...
            //  <Image src={banner} alt="hero" width={1500} height={100} className="w-full bg-cover bg-center" />
            ""

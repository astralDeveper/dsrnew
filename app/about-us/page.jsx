  ...
  return (
    ...
    <div className='mb-16 max-md:mb-10'>
      ...
      <div className='mt-20 max-w-screen-2xl mx-auto px-10 max-md:px-4 max-sm:mt-8'>
        <p className='w-[65%] max-lg:w-full'><Link href={'/pricing'} className='text-[#00A3FF]'>Join Diamond Sports Recruiting today</Link> and take the first step towards turning your college sports aspirations into reality. Let us be your trusted partner on Your Path to Athletic Scholarships.</p>
      </div>
    </div>
    </>
  )
